      ...
      <div className={styles.dialogContent}>
        <Box className={styles.walletList}>
          ...
          <Box
            ...
            {!UnipassConnecting && <Box className={styles.lastConnectType}>Recent</Box>}
          </Box>
          ...
          >
            ...
            {!MetaMaskConnecting && <Box className={styles.lastConnectType}>Recent</Box>}
          </Box>
          ...
          <Box
            ...
            {!WalletConnectConnecting && <Box className={styles.lastConnectType}>Recent</Box>}
          </Box>
