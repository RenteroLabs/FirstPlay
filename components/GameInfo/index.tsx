  ...
  return <Box className={styles.gameinfoBox}>
    {
      isMobileSize ?
        <Box className={styles.mobileBox}>
          ...
          <Typography className={styles.gameDesc}>A full-loot play-and-earn sandbox MMORPG.A full-loot play-and-earn sandbox MMORPG.A full-loot play-and-earn sandbox MMORPG.</Typography>
