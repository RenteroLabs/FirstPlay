...
const InviteFriend: React.FC<InviteFriendProps> = (props) => {
  ...
  return <div className="bg-white rounded-2xl mx-4 my-[0.83rem] px-3 py-[1.33rem]">
    ...
    <h5 className="flex justify-between items-center mb-[1.33rem] mt-[1.67rem]">
      ...
      <span className="text-primary/50 text-[1rem] font-Inter-Medium font-medium leading-4 cursor-pointer underline" onClick={() => setShowInviteeModal(true)}>View all</span>
    </h5>
    {
      isEmpty(inviteeList) ?
        <div className="text-primary/50">No invitee yet!</div>
        :
